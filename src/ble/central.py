...
class BLECentral:
    ...
    def read_gauge_reading(self, char_uuid: str) -> float:
        ...
        try:
            ...
            self.logger.info(f"Gauge value: {round(gauge_reading, 2)}")
    ...
    def read_temperature(self) -> float:
        ...
        try:
            ...
            self.logger.info(f"Temperature: {round(temperature, 2)}°C")
            return temperature
    ...
    def read_humidity(self) -> float:
        ...
        try:
            ...
            self.logger.info(f"Humidity: {round(humidity, 2)}%")
            return humidity
    ...
    def read_pressure(self) -> float:
        ...
        try:
            ...
            self.logger.info(f"Barometric Pressure: {round(pressure, 2)} kPa")
